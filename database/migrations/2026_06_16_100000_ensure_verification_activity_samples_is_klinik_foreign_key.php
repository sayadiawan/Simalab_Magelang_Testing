...
/**
 * Hubungkan tb_verification_activity_samples.is_klinik → tb_permohonan_uji_klinik_2.id_permohonan_uji_klinik
 * (samakan charset/collation, bersihkan orphan, lalu tambah FK).
 */
class EnsureVerificationActivitySamplesIsKlinikForeignKey extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('tb_verification_activity_samples')
            ...
            || !Schema::hasColumn('tb_permohonan_uji_klinik_2', 'id_permohonan_uji_klinik')) {
            return;
        }
