...
/**
 * Perbaiki sisa nomor spesimen 6000-an (mis. 6216/6217) yang belum ikut migrasi sebelumnya / masih di production.
 *
 ...
 */
class FixRemainingSpesimenNumbersStillIn6000s extends Migration
{
    const YEAR = 2026;
