...
/**
 * Pemeriksaan (verification step 3 + tglpengujian): sesuaikan tanggal dengan
 * DATE(created_at) permohonan untuk registrasi sejak 2026-08-11. Jam tetap.
 *
 * Idempotent — aman dijalankan ulang setelah 2026_08_14_160000_*.
 */
class AlignPemeriksaanKlinikDatesFromAug11 extends Migration
{
    const FROM_DATE = '2026-08-11 00:00:00';

    /** Step 3 = Pemeriksa Sampel / Input Output Hasil Px */
    const STEP_PEMERIKSAAN = 3;
    ...
    public function up(): void
    {
        ...
        $this->alignVerificationStepPemeriksaan();
    ...
    private function alignVerificationStepPemeriksaan(): void
    {
        $rows = DB::table('tb_verification_activity_samples as vas')
            ...
            ->where('vas.id_verification_activity', self::STEP_PEMERIKSAAN)
