...
class PermohonanUjiPaketExtraKlinik extends Model
{
  use SoftDeletes;
  use Uuid;

  protected $table = "tb_permohonan_uji_paket_extra_klinik";
  protected $dates = ['deleted_at'];
  public $incrementing = false;
  protected $primaryKey = 'id_permohonan_uji_paket_extra_klinik';

  protected $guarded = ['id_permohonan_uji_paket_extra_klinik'];
