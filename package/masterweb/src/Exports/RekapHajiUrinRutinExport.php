...
class RekapHajiUrinRutinExport implements FromView, ShouldAutoSize, WithEvents
{
    ...
    {
        return view('masterweb::module.admin.laboratorium.persuratan.export.rekap-haji-urin-rutin', [
            'data' => $this->data,
