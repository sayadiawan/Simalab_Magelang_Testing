...
class FormatProlanisUrineExport implements FromView
{
    protected $count;
    ...
    public function view(): View
    {
        ...
        return view('masterweb::module.admin.laboratorium.permohonan-uji-klinik-2.prolanis.format_prolanis_urine_excel', [
            'rows' => $rows,
