...
class RegisterResultClinicExport implements FromView, ShouldAutoSize, WithEvents
{
    private $data;
    private $month;
    private $year;
    ...
    public function __construct($data, $month, $year, array $layout = [])
    {
        $this->data = $data;
        $this->month = $month;
        $this->year = $year;
    ...
    {
        return view('masterweb::module.admin.laboratorium.report.v2.klinik.register-result.excel', [
            'data' => $this->data,
            'month' => $this->month,
            'year' => $this->year,
            'columnGroups' => $this->layout['groups'] ?? [],
            'columnTotal' => $this->layout['total'] ?? 0,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Center align for numeric columns (No, Umur, and result columns)
