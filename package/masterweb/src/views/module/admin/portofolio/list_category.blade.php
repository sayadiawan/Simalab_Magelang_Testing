            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="d-inline" action="{{route('adm-categoryportofolio.destroy', [$data->id_category_portofolio])}}" method="POST">
