        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        <i class="fas fa-map-marker-alt mr-2"></i>Tambah Satu Sehat Location
                    </h4>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-4">
                        <i class="fas fa-info-circle mr-1"></i>Tambah data lokasi Satu Sehat baru
                    </p>
                    <form enctype="multipart/form-data" class="forms-sample"
                        action="{{ route('adm-satusehat-location-store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="name_satusehat_location"
                                        ...
                                        value="{{ old('name_satusehat_location') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg" id="version_satusehat_location"
                                        ...
                                        <option value="prd"
                                            {{ old('version_satusehat_location') == 'prd' ? 'selected' : '' }}>
                                            Production (prd)
                                        </option>
                                        <option value="stg"
                                            {{ old('version_satusehat_location') == 'stg' ? 'selected' : '' }}>
                                            Staging (stg)
                                        </option>
                                    </select>
                        ...
                        <div class="alert alert-info">
                            ...
                            sistem akan otomatis mengirim data ke API Satu Sehat saat menyimpan.
                        </div>
