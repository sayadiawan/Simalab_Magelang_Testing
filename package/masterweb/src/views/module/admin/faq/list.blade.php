              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><label class="badge badge-info"></label>
                      @if ($data->publish == 1)
                      <a href="{{url('adm-faq/publish/'.$data->id)}}"><label class="badge badge-info">Aktif</label></a>
                      @else
                      <a href="{{url('adm-faq/publish/'.$data->id)}}"><label class="badge badge-danger">Tidak Aktif</label></a>
                      @endif
                    </td>
                    <td>
                        ...
                        <form onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')" 
                            class="d-inline" 
                            action="{{route('adm-faq.destroy', [$data->id])}}" 
                            method="POST">
