            ...
            <form enctype="multipart/form-data" class="forms-sample" id="form"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_parameter_satuan_klinik"
                        ...
                        value="{{ old('name_parameter_satuan_klinik') }}" required>
                </div>

                @include('masterweb::module.admin.laboratorium.parameter-satuan-klinik._metode-parameter-satuan-klinik-fields')
                ...
                <div class="form-group" id="loinc-non-haji-group">
                    ...
                    <input type="text" class="form-control" id="loinc_parameter_satuan_klinik"
                        ...
                        value="{{ old('loinc_parameter_satuan_klinik') }}" required>
                ...
                <div class="form-group" id="loinc-haji-group" style="display:none;">
                    ...
                    <input type="text" class="form-control" id="loinc_parameter_satuan_klinik_haji"
                        ...
                        value="{{ old('loinc_parameter_satuan_klinik_haji') }}">
                ...
                <div class="form-group" id="jenis-sampel-haji-group" style="display:none;">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="number_format_en" name="number_format" value="en" 
                                            class="custom-control-input" {{ old('number_format', 'en') == 'en' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="number_format_id" name="number_format" value="id" 
                                            class="custom-control-input" {{ old('number_format') == 'id' ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="ket_default_parameter_satuan_klinik"
                        ...
                        style="height:200px" required>{{ old('ket_default_parameter_satuan_klinik') }}</textarea>
                </div>
