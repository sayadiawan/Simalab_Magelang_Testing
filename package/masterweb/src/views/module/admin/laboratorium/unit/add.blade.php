...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
        <form enctype="multipart/form-data" class="forms-sample" action="{{route('elits-units.store')}}"  method="POST">
            @csrf
            <div class="form-group">
                <label for="name_unit">Name Unit</label>
                <input type="text" class="form-control" id="name_unit" name="name_unit" placeholder="Name Unit" required >
            </div>

            <div class="form-group">
                <label for="name_unit">Singkatan Unit</label>
                <input type="text" class="form-control" id="shortname_unit" name="shortname_unit" placeholder="Singkatan Unit" required >
            </div>
