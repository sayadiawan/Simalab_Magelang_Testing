...
<head>
    ...
    <title>Nota Magelang-KLINIK</title>
...
<body>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin: 0;">
        ...
        <tr>
            <td style="padding: 2px 3px;" colspan="2">
                <strong>No. Nota:</strong> {{ $item_permohonan_uji_klinik->getDisplayNoregister() }}
            </td>
        </tr>
        <tr>
            <td style="text-align: center; width: 40%; vertical-align: top;">
                <b style="font-size: 16px">{{ mb_strtoupper($item_permohonan_uji_klinik->pasien->nama_pasien, 'UTF-8') }}</b><br>
                            ...
                            <tr>
                                @if ($index == 0)
                                    <td rowspan="{{ count($items) }}" style="vertical-align: top; padding: 2px; border: 1px solid #000; border-left: none;">
                                        @php
                                            $jenis_sampel_display = $item_permohonan_uji_klinik->jenis_sampel;
                                ...
                                <td style="padding: 2px; text-align: right; border: 1px solid #000;">{{ number_format($item['total'], 0, ',', '.') }}</td>
                                <td style="padding: 2px; text-align: center; border: 1px solid #000;">1</td>
                                <td style="padding: 2px; text-align: right; border: 1px solid #000; border-right: none;">{{ number_format($item['total'], 0, ',', '.') }}</td>
                            </tr>
                            @php
            ...
            <td style="vertical-align: top;">
                <table width="100%" cellspacing="0" cellpadding="0" style="border: none;">
                    <tr>
                        ...
                        <td style="border: none; padding: 1px 3px;">{{ $item_permohonan_uji_klinik->pasien->phone_pasien }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border: none; padding: 1px 3px;">Nomor Sampel</td>
                        <td style="border: none; padding: 1px 3px;">:</td>
                        <td style="border: none; padding: 1px 3px;">{{ $item_permohonan_uji_klinik->getDisplayNoregister() }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td style="vertical-align: top;">
                <table width="100%" cellspacing="0" cellpadding="0" style="border: none;">
                    <tr>
                        ...
                        <td width="5px" style="border: none; padding: 1px 3px;">:</td>
                        <td style="border: none; padding: 1px 3px;">{{ number_format($item_permohonan_uji_klinik->total_harga_permohonan_uji_klinik, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            ...
            <td style="padding: 0; vertical-align: bottom; border-top-color: transparent !important;">
                <table width="100%" cellspacing="0" cellpadding="2" border="0" style="border: none; margin-top: 2px;">
                    @php
                        $biaya_pengambilan = $item_permohonan_uji_klinik->biaya_pengambilan_sampel ?? 0;
                        $total_parameter = $item_permohonan_uji_klinik->total_harga_permohonan_uji_klinik ?: ($total_harga ?? 0);
                        $total_keseluruhan = $total_parameter + $biaya_pengambilan;
                        $jumlah_dibayar = isset($dibayar) ? (float) $dibayar : (float) optional($detail_payment ?? null)->terbayar_permohonan_uji_payment_klinik;
                        $jumlah_sisa = isset($sisa) ? (float) $sisa : max(0, $total_keseluruhan - $jumlah_dibayar);
                    @endphp
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; padding: 2px; border: 1px solid #000; border-right: none;">{{ number_format($jumlah_dibayar, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: right; padding: 2px; border: 1px solid #000; border-left: none;">Sisa</td>
                        <td style="text-align: right; padding: 2px; border: 1px solid #000; border-right: none;">{{ number_format($jumlah_sisa, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table width="100%" cellspacing="0" cellpadding="2" border="0" style="margin-top: 0;">
        ...
        <tr>
            ...
            <td width="32%" style="text-align: center; vertical-align: top; padding: 3px;">
                ...
                @if (!empty($item_permohonan_uji_klinik->signature_nota_pasien))
                    <div style="height: 50px; display:flex; align-items:center; justify-content:center;">
                        <img src="data:image/png;base64,{{ base64_encode($item_permohonan_uji_klinik->signature_nota_pasien) }}"
                            alt="TTD Pelanggan" style="max-width:140px; max-height:45px; object-fit:contain;" />
                    </div>
                @else
                    <div style="height: 50px;"></div>
                @endif
                <div style="font-size: 10px; margin-top: 2px;">{{ mb_strtoupper($item_permohonan_uji_klinik->pasien->nama_pasien, 'UTF-8') }}</div>
            </td>
            <td width="33%" style="text-align: center; vertical-align: top; padding: 3px;">
                ...
                @if (!empty($item_permohonan_uji_klinik->signature_nota_petugas))
                    <div style="height: 50px; display:flex; align-items:center; justify-content:center;">
                        <img src="data:image/png;base64,{{ base64_encode($item_permohonan_uji_klinik->signature_nota_petugas) }}"
                            alt="TTD Petugas" style="max-width:140px; max-height:45px; object-fit:contain;" />
                    </div>
                @else
                    <div style="height: 50px;"></div>
                @endif
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin-top: 0;">
        ...
        <tr>
            <td style="padding: 2px 3px;" colspan="2">
                <strong>No. Nota:</strong> {{ $item_permohonan_uji_klinik->noregister_permohonan_uji_klinik }}
            </td>
        </tr>
        <tr>
            <td style="text-align: center; width: 40%; vertical-align: top;">
