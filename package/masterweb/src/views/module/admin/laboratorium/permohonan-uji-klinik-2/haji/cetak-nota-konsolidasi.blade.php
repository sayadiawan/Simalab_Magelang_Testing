...
<body>
    @php
        ...
        $biaya_pengambilan = (int) ($biaya_pengambilan ?? 0);
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin: 0;">
        ...
        <tr>
            <td style="text-align: center; width: 40%; vertical-align: top;">
                ...
                {{ \Smt\Masterweb\Helpers\Smt::formatAlamatCetak($customer->address_customer ?? '-') }}
            </td>
            ...
            <td style="vertical-align: top;">
                <table width="100%" cellspacing="0" cellpadding="0" style="border: none;">
                    <tr>
                        ...
                        <td width="5px" style="border: none; padding: 1px 3px;">:</td>
                        <td style="border: none; padding: 1px 3px;">{{ number_format($total_keseluruhan, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </td>
        </tr>
