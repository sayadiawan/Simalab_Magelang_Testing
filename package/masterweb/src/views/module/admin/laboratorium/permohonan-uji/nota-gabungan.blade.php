...
<body>
    ...
    <div class="section-content">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="1">
            <tr style="text-align: center;">
                <td colspan="2" style="text-align: center;" width="40%"><strong>KONTRAK/PERMOHONAN PEMERIKSAAN</strong></td>
            </tr>
            <tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 3px;">
            <tr>
                ...
                <td style="text-align: center; vertical-align: top; padding: 3px;">
                    @if ($permohonan_uji->status_pembayaran == "1" && !empty($permohonan_uji->tanggal_bayar))
    ...
    <div class="section-content">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="1">
            ...
            <tr>
                <td>Biaya (Rp.) <b>{{ rupiah($firstLabData['total']) }}</b></td>
            </tr>
            <tr>
                <td style="vertical-align: top;">
                    Keterangan:
