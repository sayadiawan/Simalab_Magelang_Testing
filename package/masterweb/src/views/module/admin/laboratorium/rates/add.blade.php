...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
        <form enctype="multipart/form-data" class="forms-sample" action="{{route('elits-rates.store')}}"  method="POST">
            @csrf
            <div class="form-group">
                
                <label for="params_rate">Parameter</label>
                <input type="text" class="form-control" id="params_rate" name="params_rate" placeholder="Parameter" required >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="rate_rate" name="rate_rate" placeholder="Tarif" required >
            </div>

            <div class="form-group">
                <label for="purpose_rate">Peruntukan</label>
                <input type="text" class="form-control" id="purpose_rate" name="purpose_rate" placeholder="Peruntukan" required >
            </div>
