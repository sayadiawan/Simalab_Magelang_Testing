...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('elits-jenis-sampel-klinik.update', [$id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_jenis_sampel_klinik" id="name_jenis_sampel_klinik"
                        value="{{ old('name_jenis_sampel_klinik', $item->name_jenis_sampel_klinik) }}" required maxlength="100">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="code_jenis_sampel_klinik" id="code_jenis_sampel_klinik"
                        value="{{ old('code_jenis_sampel_klinik', $item->code_jenis_sampel_klinik) }}" maxlength="50">
                </div>
