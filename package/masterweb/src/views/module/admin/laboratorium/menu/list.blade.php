                ...
                <div class="template-demo">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('/menu-elits')}}">Admin Menu</a></li>
                ...
                <div class="media-body">
                    <div class="d-flex bd-highlight">
                      ...
                      <div class="p-2 bd-highlight">
                        <p>
                          <form onsubmit="return confirm('Delete this menu permanently?')" class="d-inline" action="{{url('menu-elits/destroy/'.$menu->id)}}" method="POST">
                            @csrf
                          ...
                          <div class="d-flex bd-highlight">
                            ...
                            <div class="p-2 bd-highlight">
                              <p><form onsubmit="return confirm('Delete this user permanently?')" 
                                class="d-inline" 
                                action="{{url('menu-elits/destroy/'.$submenu->id)}}" 
                                method="POST">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="{{url('menu-elits/store')}}">
              @csrf
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="{{url('menu-elits/update')}}">
              @csrf
              <label for="recipient-name" class="col-form-label">Parent:</label>
