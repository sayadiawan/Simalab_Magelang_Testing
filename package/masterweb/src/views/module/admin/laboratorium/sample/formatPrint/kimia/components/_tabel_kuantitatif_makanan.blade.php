<table class="result" width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: center; width: 12%">Nomer Sampel</td>
            <td style="text-align: center; width: 14%">Jenis Sampel</td>
            <td style="text-align: center; width: 18%">Parameter Pemeriksaan</td>
            <td style="text-align: center; width: 10%">Satuan</td>
            <td style="text-align: center; width: 14%">Kadar maks. yang Diperbolehkan</td>
            <td style="text-align: center; width: 12%">Hasil Pemeriksaan</td>
