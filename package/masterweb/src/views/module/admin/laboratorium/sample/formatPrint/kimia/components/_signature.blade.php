...
@php
    $catatanHasilHtml = \Smt\Masterweb\Helpers\Smt::formatCatatanHasilKesmasHtml($sample ?? null);
@endphp
...
<table width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td style="text-align: left">
                ...
                @endif
            <br>
            NIP @if ($validator && isset($validator->nip))
        ...
        <td style="text-align: left">
                ...
                @endif
            <br>
            NIP @if ($verifikator && isset($verifikator->nip))
        ...
        <td style="text-align: left">
                ...
                @endif
            <br>
            NIP @if ($pemeriksa && isset($pemeriksa->nip))
