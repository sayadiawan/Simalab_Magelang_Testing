    ...
    <tbody>
            ...
            @else
                <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}"
                    ...
                    <td>
                        ...
                        <input id="start_date_registrasi" type="datetime-local" class="form-control datetime" name="start_date" required>
                    </td>
                    <td><input id="stop_date_registrasi" type="datetime-local" class="form-control datetime" name="stop_date" required></td>
                    <td>
        ...
        <tr id="registrasi-update" style="display: none">
            ...
            <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}" method="post"
                ...
                <td>
                    <input type="number" value="{{ 1 }}" name="verification_step" hidden>
                    <input type="text" class="form-control" name="start_date" id="start_date_registrasi"
                        value="{{ isset($listVerifications[1]) ? \Smt\Masterweb\Helpers\DateHelper::formatDateTimePicker($listVerifications[1]->start_date) : '' }}"
                        required></td>
                <td><input type="text" class="form-control" name="stop_date" id="stop_date_registrasi"
        ...
        @if (isset($sample->permohonanuji) && $sample->permohonanuji->is_sampling == 1)
            ...
            <tr id="pengambilan-sampel-update" style="display: none">
                ...
                <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}"
                    ...
                    <td><input type="text" class="form-control" name="stop_date"
                        ...
                        <select name="nama_petugas" id="namaPetugasPengambilanUpdate" required>
                            ...
                            @foreach ($list_name_petugas as $nama_petugas)
                                <option value="{{ trim($nama_petugas) }}"
                                    {{ isset($listVerifications[6]->nama_petugas) &&
                                    trim($listVerifications[6]->nama_petugas) == trim($nama_petugas)
                                        ? 'selected'
                                        : '' }}>
                                    {{ trim($nama_petugas) }}
                                </option>
        ...
        <tr id="penerimaan-sampel">
            ...
            @if (isset($listVerifications[7]))
                <td>{{ $listVerifications[7]->start_date }}</td>
                <td>{{ $listVerifications[7]->stop_date }}</td>
        ...
        <tr id="penerimaan-sampel-update" style="display: none">
            ...
            <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}" method="post"
                ...
                @csrf
                <td>
                    <input type="number" value="{{ 7 }}" name="verification_step" hidden>
                    <input type="text" class="form-control" name="start_date"
                ...
                <td>
                    <select name="nama_petugas" id="namaPetugasPenerimaanUpdate" required>
                        ...
                        @foreach ($list_name_petugas as $nama_petugas)
                            <option value="{{ trim($nama_petugas) }}"
                                {{ isset($listVerifications[7]->nama_petugas) &&
                                trim($listVerifications[7]->nama_petugas) == trim($nama_petugas)
                                    ? 'selected'
                                    : '' }}>
                                {{ trim($nama_petugas) }}
                            </option>
...
$is_sampling = isset($sample->permohonanuji) && $sample->permohonanuji->is_sampling == 1;
        ...
        <tr id="analitik-update" style="display:none;">
            ...
            <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}" method="post"
                ...
                <td class="text-center">
                    <button type="submit" class="btn btn-success" @if (!isset($listVerifications[7]) || (isset($listVerifications[7]) && $listVerifications[7]->is_done != 1)) disabled @endif
        ...
        <tr id="baca-hasil">
            ...
            @else
                <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}"
                    ...
                    <td><input type="text" class="form-control" name="stop_date" id="stop_date_input"
                            required></td>
            ...
            name="nama_petugas" required> --}}
                ...
                <a
                    href="{{ route('elits-baca-hasil.index', [$sample->id_samples, $lab_num->lab_id, optional($labAnalitikProgres)->id_laboratorium_progress ?? 'bc2850f5-4ec4-450f-a727-2b1428c861d9']) }}"><button
        ...
        <tr id="baca-hasil-update" style="display: none;">
            ...
            name="nama_petugas" required> --}}
                ...
                <td class="text-center">
                    <button type="submit" class="btn btn-success" @if (!isset($listVerifications[2]) or !isset($labAnalitikProgres)) disabled @endif
        ...
        <tr id="verifikasi">
            ...
            @else
                <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}"
                    ...
                    <td><input type="text" class="form-control" name="stop_date" id="stop_date_verifikasi"
                            required></td>
                    <td>
            ...
            <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}" method="post"
                ...
                <td class="text-center">
                    <button type="submit" class="btn btn-success" @if (!isset($listVerifications[3]) or !isset($verifikasiHasil) or !isset($verifikasiHasil->verifikasi_hasil_date)) disabled @endif
                        @if (config('app.bsre_use', false)) onclick="checkNikAndPassword(document.getElementById('namaPetugasVerifikasiUpdate').value, 'formVerifikasiUpdate')" @endif>Selesai</button>
            </form>
            <a href="{{ route('elits-verifikasi-hasil.index', [$sample->id_samples, $lab_num->lab_id]) }}"><button
                    type="button" class="btn btn-primary"
                    @if (!isset($listVerifications[3])) disabled @endif>Verifikasi
            ...
            @else
                <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}"
                    ...
                    <td>
                        ...
                        <input type="text" class="form-control" name="start_date" id="start_date_validasi"
                            required>
                    </td>
                    <td><input type="text" class="form-control" name="stop_date" id="stop_date_validasi"
                            required></td>
                    <td>
            ...
            <form action="{{ route('elits-samples.verification-analytic-2', [$sample->id_samples]) }}" method="post"
                ...
                <td class="text-center">
                    <button type="submit" class="btn btn-success" @if (!isset($listVerifications[4]) or !isset($pengesahanHasil) or !isset($pengesahanHasil->pengesahan_hasil_date)) disabled @endif
                        @if (config('app.bsre_use', false)) onclick="checkNikAndPassword(document.getElementById('namaPetugasValidasiUpdate').value, 'formValidasiUpdate')" @endif>Validasi</button>
            </form>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let pendaftaranStart, pendaftaranStop, pengambilanStart, pengambilanStop, penerimaanStart, penerimaanStop,
