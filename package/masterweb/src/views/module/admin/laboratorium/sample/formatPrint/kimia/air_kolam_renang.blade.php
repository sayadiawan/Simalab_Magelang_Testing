...
<body style="margin: 10px; padding: 0; font-size: {{ $fontsize }}pt; line-height: {{ $lineHeight }};">
    @if ($showKop)
            ...
            <td width="69%" style="vertical-align:top;">
                <table width="100%" cellspacing="0">
                    ...
                    @if ($keteranganMetodeCustom !== '')
                        <tr>
                            <td width="100%" style="vertical-align:top;">{{ $keteranganMetodeCustom }}</td>
                        </tr>
                    @elseif (count($all_acuan_baku_mutu) > 0)
