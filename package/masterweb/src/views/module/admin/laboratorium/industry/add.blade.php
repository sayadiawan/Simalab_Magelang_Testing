...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
        <form enctype="multipart/form-data" class="forms-sample" action="{{route('elits-industries.store')}}"  method="POST">
            @csrf
            <div class="form-group">
                <label for="name_industry">Nama Industri</label>
                <input type="text" class="form-control" id="name_industry" name="name_industry" placeholder="Nama Industri" required>
            </div>
