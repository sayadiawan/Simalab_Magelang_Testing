...
@section('content')
        ...
        <div class="card">
            ...
            <div class="template-demo">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><span>Industri Management</span></li>
                </ol>
                </nav>
            </div>
            </div>
    ...
    <div class="card-body">
      <div class="d-flex">
        ...
        <div class="p-2">
            <a href="{{route('elits-industries.create')}}">
            ...
            <table id="order-listing" class="table">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('elits-industries.edit', [$industry->id_industry])}}">
                        ...
                        <form onsubmit="return confirm('Delete this user permanently?')" 
                            class="d-inline" 
                            action="{{route('elits-industries.destroy', [$industry->id_industry])}}" 
                            method="POST">
