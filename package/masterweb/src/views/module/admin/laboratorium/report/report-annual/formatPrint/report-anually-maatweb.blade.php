...
<body style="word-wrap:break-word">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1"
                ...
                <th style="text-align: center; width: 30%" colspan="{{ count($method_all) }}">HASIL PEMERIKSAAN
                    {{ isset($item_sampletype)
                        ...
                        : (isset($item_program)
                            ...
                            : (isset($item_laboratorium)
                                ? strtoupper($item_laboratorium->nama_laboratorium)
                                : '')) }}
                </th>
            </tr>
        ...
        <tbody>
            @if (count($data_sample_method) > 0)
                @foreach ($data_sample_method as $key_dsm => $item_dsm)
                    <tr>
                        ...
                        @foreach ($item_dsm['method'] as $key_method => $hasil)
            ...
            @else
                <tr>
                    <td colspan="{{ 7 + count($method_all) }}" style="text-align: center">
