...
@section('content')
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/home') }}"><i class="fa fa-home menu-icon mr-1"></i>
                    Beranda</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/elits-sampletypes') }}">Data Jenis Sarana</a></li>
  ...
  <div class="card">
    <div class="card-body">
      <form enctype="multipart/form-data" class="forms-sample" action="{{ route('elits-sampletypes.store') }}"
        method="POST">
        @csrf
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name_sampletype" name="name_sampletype"
            placeholder="Name Sample Type" required>
        </div>
