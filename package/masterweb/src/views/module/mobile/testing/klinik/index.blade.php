...
<head>
    ...
    <title>Mobile Testing Klinik - Scan Permohonan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        @if (isset($is_authenticated) && $is_authenticated)
            <form method="POST" action="{{ route('mobile.testing.klinik.logout') }}"
        ...
        <div class="card">
            ...
            @else
                <p>Silakan scan QR code atau masukkan ID permohonan untuk memulai proses pengujian.</p>
            @endif

            <form method="POST" action="{{ route('mobile.testing.klinik.inputId') }}" style="margin-top: 16px;">
                @csrf
    ...
    <script>
        ...
        function handleScanResult(decodedText) {
            ...
            if (id_permohonan) {
                window.location.href = '{{ url('/mobile/testing-klinik/scan') }}/' + id_permohonan;
            }
        }
    </script>
</body>
