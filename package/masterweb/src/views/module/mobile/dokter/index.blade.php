...
<head>
    ...
    <title>Mobile Dokter - Scan Permohonan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <h2>Scan QR Code atau Input ID Permohonan</h2>
            @if (isset($is_authenticated) && $is_authenticated)
                <div class="alert alert-success">
                    <span>✓</span>
                    <span>Anda sudah login. Silakan scan QR code atau input ID permohonan untuk langsung ke form
                        diagnosis.</span>
                </div>
            @else
                <p>Silakan scan QR code atau masukkan ID permohonan untuk memulai proses diagnosis.</p>
            @endif

            <form method="POST" action="{{ route('mobile.dokter.inputId') }}" style="margin-top: 16px;">
                @csrf
            ...
            <div class="help-text">
                ...
                <ul>
                    ...
                    <li>Arahkan kamera ke QR code pada label permohonan</li>
                    <li>Atau gunakan aplikasi QR scanner di ponsel Anda</li>
                    <li>QR code akan otomatis terdeteksi dan Anda akan diarahkan ke form diagnosis (jika sudah login)
    ...
    <script>
        ...
        function handleScanResult(decodedText) {
            ...
            if (id_permohonan) {
                window.location.href = '{{ url('/mobile/dokter/scan') }}/' + id_permohonan;
            }
        }
    </script>
</body>
