...
<body>
        ...
        <div class="card">
            <div class="permohonan-info">
                ...
                <div class="info-item">
                    ...
                    <span>
                        @if($pasien->tgllahir_pasien)
                            @php
                                $tanggal_lahir = Carbon\Carbon::parse($pasien->tgllahir_pasien);
                ...
                <div class="info-item">
                    <label>Pasien:</label>
                    <span style="color: #999;">Data pasien tidak ditemukan</span>
                </div>
                @endif
            </div>
            ...
            <form action="{{ route('mobile.dokter.doLogin', $permohonan->id_permohonan_uji_klinik) }}" method="POST"
                autocomplete="off" novalidate id="mobileDokterLoginForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div style="margin-top: 8px;">
                        <label
                            ...
                            <input type="checkbox" id="showPasswordMobileDokter" onchange="togglePasswordMobileDokter()"
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;">
                        <img src="{{ route('captcha.generate') }}?t={{ microtime(true) }}" alt="CAPTCHA"
                            id="captchaImgMobileDokter"
                            style="height:64px; border-radius:8px; background:#eef2ff; padding:4px; cursor:pointer;"
                            title="Klik untuk refresh">
                        <button type="button"
                            onclick="document.getElementById('captchaImgMobileDokter').src='{{ route('captcha.generate') }}?t='+(Date.now())"
                ...
                <button type="submit" class="btn btn-primary">
                    <span>🔐</span>
                    <span>LOGIN & MULAI DIAGNOSIS</span>
                </button>
            </form>

            <div class="help-text">
                <strong>💡 Petunjuk:</strong><br>
                Gunakan username dan password akun dokter Anda.<br>
    ...
    <script>
        ...
        function togglePasswordMobileDokter() {
            var passwordInput = document.getElementById('password');
            var showPasswordCheckbox = document.getElementById('showPasswordMobileDokter');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var form = document.getElementById('mobileDokterLoginForm');
            if (form) {
                setTimeout(function() {
