...
<head>
    ...
    <title>Login Petugas Sampling</title>
    ...
    <!-- SPA Support - Load all pages once -->
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <form action="{{ route('mobile.sampling.login', $permohonan_uji->id_permohonan_uji) }}" method="POST"
                autocomplete="off" novalidate id="mobileSamplingLoginForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div style="margin-top: 8px;">
                        <label
                            ...
                            <input type="checkbox" id="showPasswordMobileSampling"
                                onchange="togglePasswordMobileSampling()" style="margin-right: 6px; cursor: pointer;">
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;">
                        <img src="{{ route('captcha.generate') }}?t={{ microtime(true) }}" alt="CAPTCHA"
                            id="captchaImgMobileSampling"
                            style="height:64px; border-radius:8px; background:#eef2ff; padding:4px; cursor:pointer;"
                            title="Klik untuk refresh">
                        <button type="button"
                            onclick="document.getElementById('captchaImgMobileSampling').src='{{ route('captcha.generate') }}?t='+(Date.now())"
    ...
    <script>
        ...
        function togglePasswordMobileSampling() {
            var passwordInput = document.getElementById('password');
            var showPasswordCheckbox = document.getElementById('showPasswordMobileSampling');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var form = document.getElementById('mobileSamplingLoginForm');
            if (form) {
                setTimeout(function() {
