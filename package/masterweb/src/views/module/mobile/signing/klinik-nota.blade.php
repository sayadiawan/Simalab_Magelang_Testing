...
<head>
    ...
    <title>Tanda Tangan Nota Klinik</title>
    <style>
        body {
...
<body>
    <div class="wrap">
        <div class="card">
            <div class="header">
                ...
                <div class="title">Tanda Tangan Nota Klinik</div>
            </div>
    ...
    <script>
        ...
        document.getElementById('saveBtn').onclick = function() {
            ...
            fetch('{{ route('mobile.signing.klinik.nota.save', $permohonan->id_permohonan_uji_klinik) }}', {
                    method: 'POST',
                    headers: {
