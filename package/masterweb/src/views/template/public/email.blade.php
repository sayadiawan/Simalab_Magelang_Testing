    ...
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          ...
          <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 254px;" src="{{asset('assets/public/images/logo/logo simkraf putih.png')}}" alt="" width="254" /></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 class="size-30" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;" lang="x-size-30">Hai {{ $object_email->penerima }} !</h1>
        <p class="size-20" style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;font-size: 17px;line-height: 26px;" lang="x-size-20"><span class="font-roboto">Selamat kamu terdaftar sebagai member {{$object_email->member}}.</span></p>
       
        <a href="{{ url()->current() }}/verifikasi_email/{{ $object_email->id_member }}" class="button button-red" style="Margin-top: 20px;Margin-bottom: 0;font-family: roboto,tahoma,sans-serif;font-size: 17px;line-height: 26px;color:#fff;" target="_blank"><span class="font-roboto">verifikasi</span></a>
      </div>
    </div>
