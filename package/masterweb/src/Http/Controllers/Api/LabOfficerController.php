...
class LabOfficerController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $users =  User::where('level', '=', "3382abf2-8518-42f9-91e1-096f25da8ae8")->when($request->term, function ($query) use ($request) {
        ...
        $count = User::where('level', '=', "3382abf2-8518-42f9-91e1-096f25da8ae8")->count();
